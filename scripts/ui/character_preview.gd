...
##
## The viewport, key light, ambient environment and turntable pivot are authored
## in scenes/ui/character_preview.tscn — instance that, don't `new()` this.
...
## Framed to the figure's real bounds in [method show_figure] — body shape varies
## a lot, so the camera can't just sit at a fixed distance.
@onready var _camera: Camera3D = %Camera3D
## Spins; the figure hangs under it, feet at the pivot origin.
@onready var _pivot: Node3D = %Turntable
var _figure: Node3D
